...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/libva/libva-1.3.1.ebuild,v 1.3 2014/07/15 15:47:47 pacho Exp $
...
PDEPEND="video_cards_nvidia? ( >=x11-libs/libva-vdpau-driver-0.7.4-r1[${MULTILIB_USEDEP}] )
	...
	video_cards_intel? ( >=x11-libs/libva-intel-driver-1.4.0[${MULTILIB_USEDEP}] )
	"
